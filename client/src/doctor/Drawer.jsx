...
import ViewResponses from './FullTable';
...
class ResponsiveDrawer extends React.Component {
 ...
 ViewAllHandleClick = () => {
  ...
  ViewAllResponsesHandleClick = () => {

    this.setState({
        OnDisplay:<ViewResponses email={this.props.email} token={this.state.t} handleopen={this.handleClickDialogOpen} handleError={this.handleClickerrorDialogOpen}/>
    })
    console.log("View All item Click")
  }
      ...
      <div>
        ...
        <MuiThemeProvider theme={theme2}>
           ...
           <Divider />
            ...
            <Divider/>
            <ListItem><Button onClick={this.ViewAllResponsesHandleClick.bind(this)}>View Responses</Button></ListItem>
            <Divider/>
